...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.indexOf("J", 2)); // 지정한 인덱스로부터 찾기 (char, String 모두 가능)
		...
		// 비교연산자는 값만 비교하기 때문에 참조자료형을 비교연산한게 되면 false를 리턴함
		...
		System.out.println(strArr[0]); // 배열의 첫번째 요소
		System.out.println(strArr[strArr.length-1]); // 배열의 마지막 요소
